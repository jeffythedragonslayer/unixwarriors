...
start :-
        ...
        write('recently a sudoer of darkness who goes by the handle /! (otherwise known as Slashbang),'), nl,
        ...
        write('Your goal is to assemble the four other top tier sudoers of light in the city,'), nl,
        write('known as the UNIX WARRIORS, and use the secret magic stored in a scared text called '), nl,
        write('the Man Pages to defeat the evil hacker Slashbang'), nl,
        instructions,
        look.
